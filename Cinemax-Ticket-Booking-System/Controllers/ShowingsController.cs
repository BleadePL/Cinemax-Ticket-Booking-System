...
namespace Cinemax_Ticket_Booking_System.Controllers
{
    public class ShowingsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IDScreenRoom"] = new SelectList(_context.ScreeningRoom, "IDSR", "IDSR");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IDS,ShowStart,AvailibleSeats,Price,IDMovie,IDScreenRoom")] Showing showing)
        {
            ...
            ViewData["IDScreenRoom"] = new SelectList(_context.ScreeningRoom, "IDSR", "IDSR", showing.IDScreenRoom);
            return View(showing);
        }
